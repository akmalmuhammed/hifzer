        ...
        >
          ...
          <div className="grid h-full place-items-center">
            ...
            >
              <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_18%,rgba(255,255,255,0.5),transparent_45%),radial-gradient(circle_at_82%_88%,rgba(var(--kw-accent-rgb),0.12),transparent_40%)]" />
              <div className="relative flex h-full flex-col">
                <p className="inline-flex w-fit rounded-full border border-[color:var(--kw-border)] bg-white/75 px-3 py-1.5 text-xs font-semibold uppercase tracking-[0.14em] text-[color:var(--kw-ink-2)]">
                  {activeTile.category}
                </p>
