...
export function FeatureShowcase({
  ...
  return (
    <div className="px-0 py-1 sm:px-4 sm:py-2 md:px-6 md:py-3">
      <motion.div
      ...
      >
        <div className="flex flex-1 flex-col justify-center px-5 pb-5 pt-7 sm:px-8 sm:py-10 md:px-12 md:py-14 lg:px-16 lg:py-16">
          {eyebrow ? (
            <p className="text-[11px] font-semibold uppercase tracking-[0.14em] text-[color:var(--kw-faint)]">
              {eyebrow}
            </p>
          ) : null}
          <h3 className="mt-3 max-w-none text-balance font-[family-name:var(--font-kw-display)] text-[clamp(2rem,3.8vw,3.4rem)] leading-[0.95] tracking-tight text-[color:var(--kw-ink)] sm:max-w-[14ch]">
            {title}
          </h3>
        ...
        <div className="flex flex-1 items-center justify-center overflow-hidden px-4 pb-5 pt-1 sm:px-8 sm:pb-0 md:px-10 md:py-10">
          <div className="w-full max-w-[520px] drop-shadow-[0_28px_70px_rgba(15,23,42,0.16)] md:max-w-full">
